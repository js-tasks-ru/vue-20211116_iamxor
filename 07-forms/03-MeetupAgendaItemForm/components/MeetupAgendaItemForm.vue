...
export default {
  ...
  watch: {
    ...
    'agendaItemLocal.startsAt'(newValue, oldValue) {
      const startDuration = moment.duration(this.agendaItemLocal.startsAt);
      const finishDuration = startDuration.add(this.duration);
      this.agendaItemLocal.endsAt = moment.utc(finishDuration.asMilliseconds()).format('HH:mm');
    },
  ...
  methods: {
    ...
    calculateDurations() {
      const finishDuration = moment.duration(this.agendaItemLocal.endsAt);
      const startDuration = moment.duration(this.agendaItemLocal.startsAt);
